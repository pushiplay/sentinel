...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to pushid "gobject list" output
    ...
    def pushid_serialise(self):
        import pushilib
        return pushilib.SHIM_serialise_for_pushid(self.serialise())
