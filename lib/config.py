...
sentinel_cfg = PushiConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_pushid_proto_version_with_sentinel_ping = 70207


def get_pushi_conf():
    home = os.environ.get('HOME')

    pushi_conf = os.path.join(home, ".pushicore/pushi.conf")
    if sys.platform == 'darwin':
        pushi_conf = os.path.join(home, "Library/Application Support/PushiCore/pushi.conf")

    pushi_conf = sentinel_cfg.get('pushi_conf', pushi_conf)
